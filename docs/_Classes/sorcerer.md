...
* Gain a 1d4 bonus to one attack roll, ability check, or saving throw. The roll must represent a single action that occurs entirely within a single round. You can decide to add this bonus immediately after seeing the result of the original die roll.
* Take an additional reaction, bonus action or item action.
* Act in the surprise round when you would not normally be able to do so.
